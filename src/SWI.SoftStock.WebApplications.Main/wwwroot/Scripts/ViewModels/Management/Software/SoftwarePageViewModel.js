SoftwarePageViewModel = function (defaultDataVmCnstr, contentElement, filterElement) {

    var self = new PageViewModel(contentElement);
    var urlParams = new URLSearchParams(window.location.search);
    self.menu = new SoftwareMenuViewModel();
    ...
    self.filterVM.onApplyFilter = function (data, apply) {
