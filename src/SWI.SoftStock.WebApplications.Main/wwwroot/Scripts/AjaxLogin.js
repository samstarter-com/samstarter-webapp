            ...
            $.post($form.attr('action'), $form.serializeArray())
                .done(function (json) {
                    ...
                    if (json.success) {
                        ...
                        if (json.showMailSentDialog) {
                            $.get('/Account/FinishRegister?content=1')
                                        .done(function (content) {
                                            dialogs['Account/FinishRegister'] = $('<div class="modal-popup">' + content + '</div>')
                                            .hide()
                                          ...
                                          .find('form')
                                                .submit(function (e) {
                                                    e.preventDefault();
                                                    dialogs['Account/FinishRegister'].dialog("close");
                                                    return false;
                                                })
                                            .end();
                                        });
